...
To minimize build times, I make extensive use of Cargo and Yarn caches between CI runs. You can find the GitHub Actions configurations for the [**backend server**](https://github.com/secutils-dev/secutils/blob/main/.github/workflows/ci.yml), [**Web UI client**](https://github.com/secutils-dev/secutils-webui/blob/main/.github/workflows/ci.yml), and [**documentation**](https://github.com/secutils-dev/secutils-docs/blob/main/.github/workflows/ci.yml) in the corresponding repositories.
...
That concludes today's post. Thank you for reading! In my next post, I'll be sharing my thoughts on the formal project management for projects like Secutils.dev. Stay tuned for some cost-saving tips and tricks! If it sounds interesting to you, feel free to follow me on [**Indie Hackers**](https://www.indiehackers.com/azasypkin/history), [**Twitter**](https://twitter.com/aleh_zasypkin), [**Mastodon**](https://infosec.exchange/@azasypkin), or [**LinkedIn**](https://www.linkedin.com/in/azasypkin).
